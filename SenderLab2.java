...
public class SenderLab2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Ingrese un mensaje para enviar (escriba 'exit' para salir):");
            // ! For x in range 10k
            ...
            for (String palabra : palabrasGeneradas) {
                ...
                switch (choice) {
                    case 1:
                        ...
                        System.out.println("Opción Hamming seleccionada");
                        break;
                    case 2:
                    ...
                    case 3:
                        // Calcula el valor CRC-32 y muestra el resultado
                        System.out.println("Gracias por usar signal 2!");
                        break;
                    default:
